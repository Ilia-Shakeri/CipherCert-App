        ...
        <div className="space-y-4">
          {[
            ...
            },
            {
              ...
              description: 'Trigger webhooks for events',
            },
            ...
            <button
              onClick={() =>
                setSettings({
                  ...
                  scanning: {
                    ...settings.scanning,
                    autoScan: !settings.scanning.autoScan,
                  },
                })
              }
              className="relative w-14 h-7 rounded-full transition-all duration-300 cursor-pointer"
        ...
        <div className="space-y-4">
          <div>
            ...
            <div className="flex gap-3">
              {['#22D3EE', '#10B981', '#F59E0B', '#EF4444', '#8B5CF6'].map(
                (color) => (
                  <button
                    key={color}
                    onClick={() =>
          ...
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              style={{
                backgroundColor: settings.appearance.animations
                  ? '#22D3EE'
                  : isDark
                    ? '#334155'
                    : '#CBD5E1',
            ...
            >
              <div
                className="absolute top-0.5 w-6 h-6 rounded-full bg-white shadow-md transition-all duration-300"
                style={{
                  left: settings.appearance.animations
                    ? 'calc(100% - 26px)'
                    : '2px',
                }}
              />
